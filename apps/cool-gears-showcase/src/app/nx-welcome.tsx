 ...
 * * * * * * * * * * * * * * * * * * * * * * * * * * * *
 */
export function NxWelcome(props: { title: string; children: any }) {
  return (
    <>
      <style
    ...
    html {
      ...
      --youtube-embed-border-color: #cf057c; /*rgba(55, 65, 81, 1);*/
      --youtube-embed-border-width: 8px;
      --youtube-embed-border-style: solid;
    }
    body {
      font-family: inherit;
      line-height: inherit;
